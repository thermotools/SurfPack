...
class spherical_weights(Weights):
    ...
    #     print("self.k_cos", self.k_cos)
    #     print("self.k_sin", self.k_sin)
    #     print("self.k_sin_R", self.k_sin_R)
    ...
    def analytical_fourier_weigths(self):
        ...
        self.fw3_sph = 4.0/3.0 * np.pi * self.R**3 * \
            (spherical_jn(0, self.k_sin_R) + spherical_jn(2, self.k_sin_R))
        self.fw2_sph[:] = 4.0 * np.pi * self.R**2 * spherical_jn(0, self.k_sin_R)
        self.fw2vec_sph[:] = self.k_sin * self.fw3_sph # MH: Sign ?
        #print("self.fw3_sph", self.fw3_sph)
        #print("self.fw2_sph", self.fw2_sph)
        #print("self.fw2vec_sph", self.fw2vec_sph)
...
class spherical_pc_saft_weights(spherical_weights):
    ...
    #     print("self.fw_disp.real",self.fw_disp.real)
    ...
    def analytical_fourier_weigths(self):
        ...
        #print("self.fw_disp_sph",self.fw_disp_sph)
