...
if __name__ == '__main__':
    sidebar_dir_path = f'{os.path.dirname(__file__)}/../_includes'
    for file in os.listdir(sidebar_dir_path):
        ...
        with open(f'{sidebar_dir_path}/{ifilename}', 'r') as ifile:
            table = get_table(None, '', ifile, 0)

        with open(f'{sidebar_dir_path}/{ofilename}', 'w') as ofile:
            ofile.write('<!--\n'
                        'Automatically generated file\n'
                        f'Generated by parsing : {ifilename}\n'
                        'Using the file at : docs/tools/sidebar_to_html.py\n'
                        '-->')
        ...
        print(f'Converted {ifilename} => {ofilename}')
