...
interf = PlanarInterface.from_tanh_profile(
    vle, thermopack.critical_temperature(1), domain_size=domain_size, n_grid=n_grid)
...
# Test dFdT
dFdT = interf.functional.temperature_differential(
    interf.convolver.weighted_densities)
#F = interf.functional.excess_free_energy(interf.convolver.weighted_densities)
interf_pt = PlanarInterface.from_profile(
    vle, interf.profile, domain_size=domain_size, n_grid=n_grid)
interf_pt.single_convolution()
interf_pt.functional.T = T_p
F_pt = interf_pt.functional.excess_free_energy(
    interf_pt.convolver.weighted_densities)
interf_mt = PlanarInterface.from_profile(
    vle, interf.profile, domain_size=domain_size, n_grid=n_grid)
interf_mt.single_convolution()
interf_mt.functional.T = T_m
F_mt = interf_mt.functional.excess_free_energy(
    interf_mt.convolver.weighted_densities)
...
interf_p = PlanarInterface.from_profile(
    vle_p, interf.profile, domain_size=domain_size, n_grid=n_grid)
...
interf_m = PlanarInterface.from_profile(
    vle_m, interf.profile, domain_size=domain_size, n_grid=n_grid)
