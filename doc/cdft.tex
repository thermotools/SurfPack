...
\end{equation}
The excess Helmholtz energy can be differentiated with respect to $\lambda$ using Equation \ref{eq:helm_statmec},
\begin{equation}
...
\ref{eq:first_order_pert} simply becomes
\begin{equation}
  \label{eq:mft}
...
\end{align}
Comparing equations \ref{eq:w_hat_3}, \ref{eq:w_hat_2} and \ref{eq:w_hat_2v}, we see that the equation s
\clearpage
