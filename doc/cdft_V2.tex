...
\begin{eqnarray}
  ...
  &&\hat{w}_i^{V1}=\frac{\hat{w}_i^{V2}}{2\pi R_i} 
\end{eqnarray}
...
&&\Phi_{2V,i,\text{eff}}^{hs}=\frac{1}{2\pi R_i}\frac{\partial \Phi^{hs}}{\partial n_{V1}}+\frac{\partial \Phi^{hs}}{\partial n_{V2}}
\end{eqnarray}
